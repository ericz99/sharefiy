...
export function Navbar() {
  ...
  return (
    <header
      ref={$headerRef}
      className="fixed top-0 left-0 w-full mx-auto flex items-center z-50 bg-white border-b border-solid animate-fade-in backdrop-blur-[12px] [--animation-delay:600ms] border-zinc-100 justify-between px-6 py-2 lg:px-8 lg:justify-start"
    >
      <Image
        src={"/Intellify-logos_transparent.png"}
        alt="intellify-long-logo"
        height="60"
        width="60"
        decoding="async"
      ...
      <div className="hidden lg:flex gap-4">
        ...
        <Button asChild className="bg-orange-300 hover:bg-orange-300/80">

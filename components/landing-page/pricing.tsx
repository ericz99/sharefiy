...
export function Pricing({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full flex-col gap-8 overflow-hidden rounded-2xl border border-solid border-zinc-200 p-4 text-black dark:text-white",
        isBestPlan && "border shadow-xl border-black shadow-emerald-400"
      )}
    >
      {isBestPlan && (
        <div className="absolute top-3 right-3 shadow-emerald-400 bg-emerald-600 text-white p-1 rounded-lg z-10 text-xs">
          POPULAR
        </div>
      )}

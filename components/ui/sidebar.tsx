...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "relative ml-4 flex min-w-0 flex-col gap-1 border-l border-sidebar-border pl-4 py-1",
      "before:absolute before:left-0 before:top-0 before:h-full before:w-px before:bg-sidebar-border",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
